...
def mark_fingers(frame_in,hull,pt,radius):
    ...
    # if int(finger_count) >= 1 and finger_count <= 2:
    #     # face2 = cv2.resize(face2, (20, 20))
    #     # cv2.rectangle(frame_in, (40, 40), (70, 70), (0, 255, 0), 2)
    #     # frame_in[40:70, 40:70] = face2
    #     cv2.circle(frame_in,(200,200),50,(55,255,155),8)
    # elif(finger_count > 2) and finger_count <= 4:
    #     cv2.line(frame_in, (0, 0), (511, 511), 255, 5)
    # elif(finger_count > 4):
    #     cv2.circle(frame_in, (200, 200), 50, (55, 255, 155), 20)
    ...
    if (not (capture_done and bg_captured)):
        ...
        if(found):
            ...
            if(hand_size_score):
                ...
                if str(gesture_found) == 'L':
                    cv2.destroyAllWindows()
                    main_function(1)
                    continue
                elif str(gesture_found) == 'V':
                    cv2.destroyAllWindows()
                    main_function(2)
                    continue
        else:
